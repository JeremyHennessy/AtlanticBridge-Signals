...
| Establishment/project-development/current footprint corroborated beyond registry | 5 | LINET founding; AIUT Canadian branch establishment; Trillium contracted LCBO distribution-centre project; Britishvolt project development; Pegasi Ontario continuation/current Toronto footprint. Exact first operations remain unresolved |
| Registry establishment only; operating outcome unresolved | 17 | Require dated operational and notification-purpose evidence |
