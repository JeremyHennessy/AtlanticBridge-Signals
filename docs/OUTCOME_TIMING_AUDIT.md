...
| Establishment/project-development/recruitment/current footprint corroborated beyond registry | 6 | LINET founding; AIUT Canadian branch establishment; Trillium contracted LCBO distribution-centre project; Britishvolt project development; Pegasi Ontario continuation/current Toronto footprint; Relieve Windsor engineering recruitment. Exact first operations remain unresolved |
| Registry establishment only; operating outcome unresolved | 16 | Require dated operational and notification-purpose evidence |
