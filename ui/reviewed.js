...
function renderReviewedCompany(p){
  ...
  <div class="dossier-columns"><section class="panel dossier-evidence"><div class="panel-header"><div><p class="eyebrow">What is supported</p><h2>The reviewed evidence</h2></div></div><div class="coverage-stack"><p>${escapeHtml(p.summary)}</p><p><strong>What to investigate next:</strong> ${escapeHtml(p.next_action)}</p><div class="notice">Current project status is not established by this historical review. Source publication dates, observation dates and operating-by bounds are different. Expansion likelihood remains unvalidated.</div></div></section>
